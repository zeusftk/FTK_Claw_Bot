...
| WSL | WSL2 已安装并配置 |
| Python | Python 3.10+ |
| 内存 | 至少 4GB 可用内存（启用 Embedding 服务建议 8GB+） |
...
│   │   │   ├── local_services_panel.py # 本地服务面板
│   │   │   ├── log_panel.py            # 日志面板
...
│   ├── resources/            # 资源文件
│   │   └── models/           # AI 模型文件
│   │       └── Qwen3-Embedding-0.6B-ONNX/  # Embedding 模型
│   ├── services/             # 服务层
...
│   └── nanobot-0.1.4.3-py3-none-any.whl # nanobot wheel包
...
| 服务 | 端口 | 说明 |
|------|------|------|
| IPC Bridge | 9527 | 进程间通信桥接 |
| Gateway | 18888 | Clawbot Gateway |
| Embedding | 8765 | 文本向量化服务 |
